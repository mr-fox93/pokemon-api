...
const PokemonCard = ({ pokemon, setPokemons }) => {
  ...
  const saveAsNew = (data) => {
    ...
    //setNewPokemon((prevPokemons) => [...prevPokemons, newPokemon]);
    ...
    //setNewPokemon(newPokemon);
    //setPokemons((prevPokemon) => [...prevPokemon, newPokemon]);
    localStorage.setItem(newPokemon.name, JSON.stringify(newPokemon));
  };
        ...
        <>
          ...
          {showEditFields && (
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Button
                style={{ background: "transparent" }}
                onClick={handleSubmit(saveAsNew)}
              >
                <Icon name="save icon" /> SAVE AS NEW
              </Button>
            </form>
          )}
        </>
